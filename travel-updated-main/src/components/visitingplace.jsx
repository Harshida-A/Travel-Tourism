...
{ name: "Dongargarh", img: "https://s7ap1.scene7.com/is/image/incredibleindia/old-maa-bamleshwari-devi-dongargarh-rajnandgaon-chhattisgarh-3-attr-hero?qlt=82&ts=1754895220823", desc: "Famous for the Maa Bamleshwari Temple on a hilltop." }
  ...
  "Goa": [
    { name: "Baga Beach", img: "URL_HERE", desc: "Famous beach with nightlife." },
    { name: "Basilica of Bom Jesus", img: "URL_HERE", desc: "UNESCO World Heritage site." },
    { name: "Calangute Beach", img: "URL_HERE", desc: "Largest and most popular beach in Goa." },
{ name: "Fort Aguada", img: "URL_HERE", desc: "17th-century Portuguese fort with sea views." },
{ name: "Dudhsagar Falls", img: "URL_HERE", desc: "Spectacular four-tiered waterfall." },
{ name: "Anjuna Beach", img: "URL_HERE", desc: "Known for its flea market and parties." },
{ name: "Chapora Fort", img: "URL_HERE", desc: "Iconic fort offering panoramic views." },
{ name: "Colva Beach", img: "URL_HERE", desc: "Popular beach with water activities." },
{ name: "Palolem Beach", img: "URL_HERE", desc: "Scenic crescent-shaped beach." },
{ name: "Se Cathedral", img: "URL_HERE", desc: "One of Asia’s largest churches." }

    ],
  "Gujarat": [
    { name: "Statue of Unity", img: "URL_HERE", desc: "Tallest statue in the world." },
    { name: "Gir National Park", img: "URL_HERE", desc: "Home of Asiatic lions." },
    { name: "Somnath Temple", img: "", desc: "Ancient temple and important pilgrimage site." },
    { name: "Rann of Kutch", img: "", desc: "Vast salt desert known for Rann Utsav festival." },
    { name: "Ahmedabad", img: "", desc: "Historic city famous for heritage sites and Sabarmati Ashram." },
    { name: "Dwarkadhish Temple", img: "", desc: "Temple dedicated to Lord Krishna in Dwarka." },
    { name: "Saputara", img: "", desc: "Hill station on the Gujarat-Maharashtra border." },
    { name: "Bhuj", img: "", desc: "Gateway to Kutch region with rich culture and crafts." },
    { name: "Lothal", img: "", desc: "Ancient Indus Valley Civilization site." },
    { name: "Modhera Sun Temple", img: "", desc: "Ancient temple dedicated to the Sun God." }

  ],
  "Haryana": [
    { name: "Kurukshetra", img: "URL_HERE", desc: "Historic city from Mahabharata." },
    { name: "Sultanpur Bird Sanctuary", img: "URL_HERE", desc: "Famous for migratory birds." },
    { name: "Pinjore Gardens", img: "URL_HERE", desc: "Historic Mughal-style terraced garden." },
{ name: "Morni Hills", img: "URL_HERE", desc: "Only hill station of Haryana." },
{ name: "Badkhal Lake", img: "URL_HERE", desc: "Scenic lake surrounded by Aravalli hills." },
